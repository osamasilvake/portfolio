(globalThis['TURBOPACK'] || (globalThis['TURBOPACK'] = [])).push([
	...
	'[project]/node_modules/.pnpm/next@16.2.7_@babel+core@7.29.7_react-dom@19.2.7_react@19.2.7__react@19.2.7_sass@1.100.0/node_modules/next/dist/compiled/react-server-dom-turbopack/cjs/react-server-dom-turbopack-client.browser.development.js [app-client] (ecmascript)',
			...
			(function () {
							...
							if (null === value) {
								...
								if ('Array' === propKey) {
									if (
										...
										typeName &&
											addValueToProperties((100).toString(), '\u2026', properties, indent + 1, prefix);
										return;
									}
								}
								if ('Promise' === propKey) {
				...
				function reportGlobalError(weakResponse, error) {
					if (!hasGCedResponse(weakResponse)) {
						...
						response._chunks.forEach(function (chunk) {
							'pending' === chunk.status
								? triggerErrorOnChunk(response, chunk, error)
								: 'fulfilled' === chunk.status && null !== chunk.reason && chunk.reason.error(error);
						});
					...
					switch (reference.status) {
						case 'fulfilled':
							...
							if (parentObject[0] !== REACT_ELEMENT_TYPE || ('4' !== key && '5' !== key))
								isInitializingDebugInfo || transferReferencedDebugInfo(initializingChunk, reference);
							return response;
						case 'pending':
						case 'blocked':
							return waitForReference(
				...
				function createFakeFunction(
					...
					1 > line
						? ((line = encodedName.length + 3),
							...
							0 > col && (col = 0),
							(encodedName =
								'({' + encodedName + ':' + ' '.repeat(enclosingCol) + '_=>' + ' '.repeat(col) + '_()})'))
						: 1 > enclosingLine
							...
							if (-1 < lastIdx)
								((rowLength = new Uint8Array(chunk.buffer, offset, lastIdx - i)),
									98 === rowTag
										...
										: processFullBinaryRow(weakResponse, streamState, rowID, rowTag, buffer, rowLength),
									(i = lastIdx),
									3 === rowState && i++,
				...
				function createResponseFromOptions(options) {
					var debugChannel =
						...
						temporaryReferences = options && options.temporaryReferences ? options.temporaryReferences : void 0,
						allowPartialStream =
							options && options.unstable_allowPartialStream ? options.unstable_allowPartialStream : !1,
						findSourceMapURL = options && options.findSourceMapURL ? options.findSourceMapURL : void 0,
	...
	'[project]/node_modules/.pnpm/next@16.2.7_@babel+core@7.29.7_react-dom@19.2.7_react@19.2.7__react@19.2.7_sass@1.100.0/node_modules/next/dist/compiled/react-server-dom-turbopack/client.browser.js [app-client] (ecmascript)',
	(__turbopack_context__, module, exports) => {
		'use strict';
...
//# sourceMappingURL=11ia_next_dist_compiled_react-server-dom-turbopack_0hsqoql._.js.map
